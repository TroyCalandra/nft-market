...
const Header = () => {
    ...
    <nav x-data="{ open: true }" className={"bg-gray-800"}>
        ...
        <div className={"relative flex items-center justify-between h-16"}>
            ...
            <div className={"hidden sm:block sm:ml-6"}>
                <div className={"flex"}>
                    ...
                    <a href="/" className={"ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out"}>Media</a>
        ...
        <div className={"px-2 pt-2 pb-3"}>
            ...
            <a href="/" className={"mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out"}>Media</a>
